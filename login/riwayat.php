                ...
                <tbody>
                    <?php
                        ...
                        $ambil = $conn->query("SELECT DISTINCT headerservices.id,transactiondate,status,resi,totalpembelian FROM headerservices 
                                                ...
                                                WHERE headerservices.userid = $pelanggan AND headerservices.status = 'PESANAN DITERIMA';");
                    ...
                    <tr class="tr-shadow">
                        ...
                        <td>
                            <a href = "../marketplace/nota.php?id=<?=$_SESSION['pelanggan']?>"class="au-btn au-btn-icon au-btn--green au-btn--small" style="background:darkcyan; text-decoration: none">
                                Nota
                            </a>
                            <?php
